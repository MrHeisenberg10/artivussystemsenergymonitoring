      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-5 border-b" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
          <div className="w-9 h-9 flex items-center justify-center flex-shrink-0">
            <img src="D:\finalfilesforlogoletterheadandbusinesscard\finalfilesforlogoletterheadandbusinesscard\3.jpg" alt="Logo" className="w-full h-full object-contain rounded-lg" />
          </div>
          {sidebarOpen && (
            <div>
